	...
	<form id="fm" action="" method="post">
		<table cellpadding="6px" align="center">
			...
			<tr>
				<td>用户名：</td>
				<td>
					<input value="邱继涛" type="text" id="userName" name="username" class="easyui-validatebox" required="true" style="width: 200px"/>
				</td>
			</tr>
			<tr>
				<td>密码：</td>
				<td>
					<input value="0319" type="password" id="password" name="userpwd" class="easyui-validatebox" required="true" style="width: 200px"/>
				</td>
			</tr>
