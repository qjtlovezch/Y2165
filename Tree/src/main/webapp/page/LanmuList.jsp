...
<head>
 ...
 <%--   <script type="text/javascript"
    ...
    <script type="text/javascript">
        ...
        $(function () {
            $("#tt").tree({
                url: '${pageContext.request.contextPath}/content/columnlist',
                animate: true,
                cascadeCheck: false,
...
<div class="easyui-layout" style="width:1150px;height:550px;">
    <div region="west" split="true" title="默认站点" style="width:200px;">
        <ul id="tt">
        </ul>
    </div>
    <div region="center" >
        <div class="easyui-tabs" fit="true" border="false" id="tabs">
            <div title="首页" data-options="iconCls:'icon-home'">
                <div align="center" style="padding-top: 100px;"><font  color="green" size="500">内容管理</font></div>
            </div>
        </div>
    </div>
</div>
