...
<!--主体内容-->
    <section class="publicMian ">
        ...
        <div class="right">
            ...
            <form id="stuForm" action="/getbills"  method="post">
                <div class="search">
                    <span>商品名称：</span>
...
<c:forEach items="${page.list}" var="item">
    <tr>
        ...
        <td>
            <a href="${pageContext.request.contextPath}/billuser/${item.id}"><img src="${pageContext.request.contextPath}/shopping/img/read.png" alt="查看" title="查看"/></a>
            <a href="${pageContext.request.contextPath}/CBill/${item.id}"><img src="${pageContext.request.contextPath}/shopping/img/xiugai.png" alt="修改" title="修改"/></a>
            <a href="${pageContext.request.contextPath}/Bdel/${item.id}" class="removeBill"><img src="${pageContext.request.contextPath}/shopping/img/schu.png" onclick="del()" alt="删除" title="删除"/></a>
        </td>
    </tr>
</c:forEach>
            ...
            <div>
                ...
                <a href="/getbill?pn=${page.pages}">尾页</a>
            </div>
        </div>
    </section>
    <footer class="footer">
