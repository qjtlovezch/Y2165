...
<script>
    function userAdd() {
        $.post('/user/userAddsss',$("#form1").serialize(),function (data) {
            if(data==true){
                alert('添加成功')
            }else {
                alert('添加失败')
...
<section class="publicMian ">
    ...
    <div class="right">
        ...
        <div class="providerAdd">
            <form  id="form1" action="${pageContext.request.contextPath}/user/userAdds" method="post">
                ...
                <div>
                    ...
                    <input type="text" name="userPasord" id="userRemi"/>
                    <span>*请输入确认密码</span>
                </div>
                <div>
                    <label >用户性别：</label>
                ...
                <div class="providerAddBtn">
                    ...
                    <input type="button" onclick="userAdd()" value="保存2"/>
